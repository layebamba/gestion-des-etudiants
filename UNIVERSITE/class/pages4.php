...
<div class="form-row">
      <div class="form-group col-md-6">
        <input type="text" class="form-control" name="prenom" placeholder="Search">
      </div>
...
/*if($R){
echo "resultat du recherche effectué";
$nbetu=bdd_num_rows($R);
if($nbetu>0){
    echo "<table border='1'> \n";
    echo "<tr>\n ";
    echo "<td>" .$nbetu['ID_E']."</td>";
    echo "<td>" .$nbetu['MATRICULE']."</td>";
    echo "<td>" .$nbetu['NOM']."</td>";
    echo "<td>" .$nbetu['PRENOM']."</td>";
    echo "<td>" .$nbetu['EMAIL']."</td>";
    echo "<td>" .$nbetu['TELEPHONE']."</td>";
     echo "<td>" .$nbetu['DATENAISSANCE']."</td>"
     ;echo "<tr>\n ";
     while($nbetu=bdd_fetch_array($R)){
